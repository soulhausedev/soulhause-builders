...
export function Footer() {
  return (
    <footer className="border-t border-border bg-cream py-8">
      <div className="mx-auto max-w-6xl px-4 flex flex-col gap-4">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-muted">
          <span>© {new Date().getFullYear()} Soulhause Builders · an extension of Soul Labs</span>
          <div className="flex flex-wrap items-center justify-center gap-2">
            <SoulhauseMission variant="compact" />
            <a
